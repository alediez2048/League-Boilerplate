...
$(document).ready(function() {
  $('input#search').on('keyup', function () {
    ...
    for (var item in result) {
      ...
      var searchitem = '<div class="widget-recent-posts"><div class="result entry"><img src={{ "/assets/images/blog/thumb/"| relative_url}}'+store[ref].image+' alt="'+store[ref].title+'" class="result-img"><div class="result entry-desc"><div class="entry-title"><a href="'+store[ref].link+'" class="post-title">'+store[ref].title+'</a><p class="p">'+store[ref].category+' &minus; '+store[ref].date+'</p></div><p>'+store[ref].excerpt+'</p></div><hr></div>';
